...
# login et un mot de passe avaient été fournis. Payé dans le rapport Produit-11 du 17/08 : non_juge[0]
...
# servie de Produit-11 (React 18 + Ant Design, `/login`) : à l instant du `domcontentloaded` le DOM est
...
def _constater_ouverture(
    ...
    Dans l ordre de force :
      - un cookie de session a été POSÉ pendant la soumission (cas réel Produit-11 : deux cookies JWT,
