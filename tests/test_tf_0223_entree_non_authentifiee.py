...
Fait mesuré en production le 14/08, sur l instance du produit `Ventilation de facture SFR` :
...
def test_le_marqueur_DECLARE_pour_la_route_d_arrivee_prime_sur_le_titre() -> None:
    ...
    config = _config(marqueurs={"/login": "Connexion à Ventilation SFR"})
    ...
    present = _entree(
        chaine, corps="<h1>Connexion à Ventilation SFR</h1>", titre="Connexion à Ventilation SFR"
    )
